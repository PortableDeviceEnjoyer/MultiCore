...
#ifdef __REACTOS__
        pos = vbscript_FindStringOrdinal(FIND_FROMSTART, ptr, string_end - ptr,
#else
...
#ifdef __REACTOS__
INT WINAPI vbscript_FindStringOrdinal(DWORD flag, const WCHAR *src, INT src_size, const WCHAR *val, INT val_size, BOOL ignore_case)
{
