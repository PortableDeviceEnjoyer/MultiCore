...
#ifdef __REACTOS__
        ret = vbscript_FindStringOrdinal(FIND_FROMSTART, str1 + start, SysStringLen(str1)-start,
#else
...
static HRESULT Global_Split(BuiltinDisp *This, VARIANT *args, unsigned args_cnt, VARIANT *res)
{
    ...
    while(1) {
        ...
        if (delimiterlen) {
#ifdef __REACTOS__
            ret = vbscript_FindStringOrdinal(FIND_FROMSTART, string + start, len - start,
#else
...
#ifdef __REACTOS__
        ret = vbscript_FindStringOrdinal(FIND_FROMEND, str1, start,
#else
